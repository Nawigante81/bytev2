...
-- UWAGA: Usunięto politykę publicznego dostępu do tworzenia zgłoszeń napraw
-- Zgłoszenia napraw mogą być tworzone tylko przez:
-- 1. Panel administracyjny / zaplecze
-- 2. Edge Functions z uprawnieniami service_role
-- 3. Zalogowanych użytkowników z kontem klienta
...
-- ⚠️ BEZPIECZEŃSTWO: Teoretycznie można pobrać wszystkie "publiczne" naprawy
-- ✅ ZASTOSOWANIE: System śledzenia napraw /sledzenie?code=ABC123
-- ✅ BEZPIECZEŃSTWO: public_code są losowe i trudne do odgadnięcia
